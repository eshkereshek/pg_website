      ...
      <div className="download-hero">
        <div className="download-hero-content">
          <div className="download-hero-text">
            ...
            <a href="https://github.com/eshkereshek/pg_launcher/releases/latest/download/Pagrysha.Launcher.7.0.4.exe" className="download-btn-green" target="_blank" rel="noreferrer">
