      ...
      <div className="download-versions">
        ...
        <div className="versions-grid">
          ...
          <div className="version-card">
            ...
            <a href="https://github.com/eshkereshek/pg_launcher/releases/latest/download/Pagrysha.Launcher.7.0.3.exe" className="version-btn" target="_blank" rel="noreferrer">
