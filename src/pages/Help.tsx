...
const FAQ_ITEMS: FAQItem[] = [
  ...
  },
  {
    ...
    popular: true,
    answer: 'В 90% случаев краши возникают из-за несовместимой версии Java или конфликтующих модов. В настройках лаунчера активируйте функцию "Автовыбор Java" — лаунчер сам подберет правильную версии Java (Java 8 для старых версий 1.12.2, Java 17/21 для новейших версий 1.20.x). Если проблема сохраняется, отправьте файл latest.log из папки .minecraft в нашу поддержку.'
  },
  {
    id: 'exit-code-1',
    category: 'tech',
  ...
  },
  {
    ...
    answer: 'Файлы логов находятся в папке игры в подпапках `.minecraft/logs/latest.log` или `.minecraft/crash-reports/`. В настройках лаунчера есть кнопка "Открыть папку игры", которая сразу перейдет в нужную директорию.'
  },
  ...
  // --- ЛАУНЧЕР ---
  {
    ...
    popular: true,
    answer: 'Откройте встроенную вкладку "Моды" или "Сборки" прямо в лаунчере, найдите нужный мод через поиск и нажмите кнопку "Установить". Лаунчер автоматически загрузит мод и все необходимые зависимости (Fabric API, Forge, Cloth Config и т.д.).'
  },
  {
    id: 'accounts',
    category: 'launcher',
    ...
    popular: true,
    answer: 'Pagrysha Launcher поддерживает оффлайн-аккаунты (без интернета), аккаунты системы Ely.by, а также официальные лицензионные аккаунты Microsoft/Mojang. Переключаться между ними можно в один клик прямо на главном экране лаунчера.'
  },
  {
    id: 'modpacks',
    category: 'launcher',
    question: 'Как скачивать готовые сборки модов в один клик?',
    answer: 'Перейдите в раздел "Сборки модов" в меню лаунчера. Выберите понравившуюся сборку с Modrinth или CurseForge и нажмите "Скачать". Лаунчер сам создаст отдельный профиль со всеми необходимыми модами и настройками.'
  },
  {
    id: 'game-dir',
    category: 'launcher',
    question: 'Где находятся файлы игры и папка .minecraft?',
    answer: 'По умолчанию файлы игры хранятся в `%appdata%\.minecraft` на Windows. Вы можете открыть эту папку нажатием на иконку папки в настройках лаунчера.'
  },
  {
    id: 'version-manager',
    category: 'launcher',
    question: 'Как переключаться между версиями игры?',
    answer: 'На главном экране лаунчера выберите нужную версию из выпадающего списка (Vanilla, Fabric, Forge, NeoForge, OptiFine) или создайте новый профиль с выбранной версией в менеджере версий.'
  },
